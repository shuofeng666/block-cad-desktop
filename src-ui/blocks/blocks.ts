...
// 创建CodeGenerator的子类
class CADCodeGenerator extends Blockly.CodeGenerator {
  constructor() {
    super('cad');
  }

  // 重写保护方法
  protected scrub_(block: Blockly.Block, code: string, thisOnly?: boolean): string {
...
// 使用子类创建实例
export const codeGenerator = new CADCodeGenerator();
